          ...
          <>
            ...
            <View style={[styles.statsCard, { backgroundColor: colors.card }]}>
              ...
              <View style={styles.statsRow}>
                {[
                  { label: 'SOS Triggered', value: totalSOS, icon: 'alert-circle' as const, color: colors.primary },
                  { label: 'Journeys', value: journeysCompleted, icon: 'navigation' as const, color: colors.safe },
                  { label: 'Incidents', value: incidentsReported, icon: 'flag' as const, color: colors.accent },
                ].map((s, i) => (
            ...
            <View style={[styles.aboutCard, { backgroundColor: colors.card }]}>
              ...
              <Text style={[styles.aboutText, { color: colors.mutedForeground }]}>
                Rakshak is your quiet guardian — a women's safety companion that works entirely offline. All data is stored on your device. No data is shared with third parties.
              </Text>
        ...
        {activeTab === 'contacts' && (
          <>
            <View style={[styles.encryptBanner, { backgroundColor: colors.safe + '15' }]}>
              <Feather name="lock" size={14} color={colors.safe} />
              <Text style={[styles.encryptText, { color: colors.safe }]}>
                Contacts are stored securely on your device
              </Text>
            </View>
            ...
            {addingContact ? (
              <View style={[styles.addForm, { backgroundColor: colors.card }]}>
                ...
                <View style={styles.addActions}>
                  ...
                  >
                    <Text style={[styles.cancelAddText, { color: colors.mutedForeground }]}>Cancel</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
              ...
              <TouchableOpacity
                style={[styles.addContactBtn, { borderColor: colors.primary, borderStyle: 'dashed' }]}
        ...
        {activeTab === 'evidence' && (
          <>
            <View style={[styles.encryptBanner, { backgroundColor: colors.safe + '15' }]}>
              <Feather name="lock" size={14} color={colors.safe} />
              <Text style={[styles.encryptText, { color: colors.safe }]}>
                All recordings are stored locally and encrypted
              </Text>
            </View>

            {evidence.map(e => (
              <View key={e.id} style={[styles.evidenceCard, { backgroundColor: colors.card }]}>
                <View style={[styles.evidenceIcon, {
                  backgroundColor: e.type === 'Audio' ? colors.accent + '20' : colors.primary + '20',
                }]}>
                  <Feather
                    name={e.type === 'Audio' ? 'mic' : 'video'}
                    size={18}
                    color={e.type === 'Audio' ? colors.accent : colors.primary}
                  />
                </View>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={[styles.evidenceDuration, { color: colors.mutedForeground }]}>
                    {e.duration} · {e.sosEvent}
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    marginBottom: 12,
    shadowColor: '#C0445A', shadowOffset: { width: 0, height: 8 },
  ...
  nameInput: {
    ...
    borderWidth: 1.5, fontSize: 16, width: 200,
  },
  saveNameBtn: {
  ...
  aboutCard: {
    borderRadius: 20, padding: 18, marginBottom: 14, alignItems: 'center',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.08, shadowRadius: 12, elevation: 4,
  },
  aboutIcon: {
  ...
  addInput: {
    ...
    paddingHorizontal: 14, fontSize: 15, marginBottom: 10,
  },
  ...
  addContactBtn: {
    ...
    gap: 8, height: 52, borderRadius: 16, borderWidth: 2, marginBottom: 10,
  },
